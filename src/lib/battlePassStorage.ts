...
export const BATTLE_PASS_TIERS: BattlePassTier[] = [
  ...
  { tier: 4,  xpRequired: 370,  isMilestone: false, reward: { type: 'chest',  label: '1 Peti Misteri', value: 1,   emoji: '📦' } },
  ...
  { tier: 9,  xpRequired: 1570, isMilestone: false, reward: { type: 'chest',  label: '2 Peti Misteri', value: 2,   emoji: '📦' } },
  ...
  { tier: 13, xpRequired: 3070, isMilestone: false, reward: { type: 'chest',  label: '2 Peti Misteri', value: 2,   emoji: '📦' } },
  ...
  { tier: 17, xpRequired: 5050, isMilestone: false, reward: { type: 'chest',  label: '3 Peti Misteri', value: 3,   emoji: '📦' } },
  ...
  { tier: 23, xpRequired: 8920, isMilestone: false, reward: { type: 'chest',  label: '3 Peti Misteri', value: 3,   emoji: '📦' } },
  ...
  { tier: 27, xpRequired: 12100,isMilestone: false, reward: { type: 'chest',  label: '4 Peti Misteri', value: 4,   emoji: '📦' } },
